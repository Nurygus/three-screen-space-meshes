...
void main() {
  ...
  float radiusTexels = clamp((radiusWorld * targetSize.y * captureProjectionMatrix[1][1]) / (2.0 * cameraDepth), 1.0, ${Vd.toFixed(1)});
  gl_Position = clip;
...
`,Xd=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),$=e(((e,t)=>{t.exports=Xd()}))(),Zd={WebGPU:`webgpu`,WebGL:`webgl`,"CPU Ref":`webgl-cpu`},Qd={Beauty:`beauty`,Mesh:`mesh`,Particles:`particles`,Depth:`depth`,Compare:`compare`},$d={Vortex:`vortex`,Sheet:`sheet`,Crown:`crown`},ef={radius:{min:.04,max:.8,step:.01},depthBlur:{min:0,max:8,step:1},boundaryRelax:{min:0,max:10,step:1},zMax:{min:.01,max:4,step:.01}};function tf(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),n=(0,l.useRef)(Ed),r=(0,l.useRef)(null),i=(0,l.useRef)([]),a=(0,l.useRef)(null),o=(0,l.useRef)(null),s=(0,l.useRef)(null),[c,u]=(0,l.useState)(()=>mf()),[d,f]=(0,l.useState)(Ed),[p,m]=(0,l.useState)(kd),[h,g]=(0,l.useState)(null),_=(0,l.useCallback)(e=>{f(t=>({...t,...e}))},[]),v=(0,l.useCallback)(()=>{f({...Ed})},[]),y=(0,l.useCallback)(e=>{let t=new URL(window.location.href);e===`webgpu`?t.searchParams.delete(`engine`):t.searchParams.set(`engine`,e),window.history.pushState(null,``,t),u(e)},[]);(0,l.useEffect)(()=>{n.current=d},[d]),(0,l.useEffect)(()=>{let r=e.current;if(!r)return;g(null),m({...kd,backend:hf(c)});let i=n.current,a=c===`webgpu`?new bu(r,i,m):c===`webgl`?new Ud(r,i,m):new Nd(r,i,m);return t.current=a,a.start().catch(e=>{g(e instanceof Error?e.message:`Renderer failed to start`)}),()=>{a.dispose(),t.current=null}},[c]),(0,l.useEffect)(()=>{t.current?.updateSettings(d)},[d]),(0,l.useEffect)(()=>{let e=nf(n.current,c,v),t=new C({title:`Controls`,width:300}),l=[];r.current=e;let u=t.add(e,`renderer`,Zd).name(`renderer`);u.onChange(e=>y(e)),l.push(u);let d=t.addFolder(`view`),f=d.add(e,`mode`,Qd).name(`mode`);f.onChange(e=>_({mode:e})),l.push(f);let p=d.add(e,`split`,.3,.7,.01).name(`split`);p.onChange(e=>_({split:e})),p.show(e.mode===`compare`),s.current=p,l.push(p);let m=t.addFolder(`simulation`),h=m.add(e,`flow`,$d).name(`flow`);h.onChange(e=>_({preset:e})),l.push(h);let g=m.add(e,`particles`,700,22e3,500).name(`particles`);g.onChange(e=>_({particleCount:e})),l.push(g);let b=m.add(e,`animate`).name(`animate`);b.onChange(e=>_({animate:e})),l.push(b);let x=m.add(e,`freeze`).name(`freeze surface`);x.onChange(e=>_({freezeSurface:e})),l.push(x);let S=t.addFolder(`reconstruction`),w=S.add(e,`grid`,1,14,1).name(`grid px`);w.onChange(e=>_({gridSpacing:e})),l.push(w);let T=S.add(e,`radius`,ef.radius.min,ef.radius.max,ef.radius.step).name(`radius`);T.onChange(e=>_({particleRadius:e})),l.push(T);let E=S.add(e,`depthBlur`,ef.depthBlur.min,ef.depthBlur.max,ef.depthBlur.step).name(`depth blur`);E.onChange(e=>_({depthSmoothing:e})),l.push(E);let D=S.add(e,`silhouette`,ef.boundaryRelax.min,ef.boundaryRelax.max,ef.boundaryRelax.step).name(`boundary relax`);D.onChange(e=>_({silhouetteSmoothing:e})),D.enable(c!==`webgl`),a.current=D,l.push(D);let O=S.add(e,`explicitZMax`).name(`explicit zmax`);O.onChange(e=>_({useExplicitZMax:e})),l.push(O);let k=S.add(e,`zMax`,ef.zMax.min,ef.zMax.max,ef.zMax.step).name(`zmax`);k.onChange(e=>_({zMax:e})),k.enable(e.explicitZMax),o.current=k,l.push(k);let A=t.addFolder(`material`).add(e,`thickness`,.12,.9,.02).name(`thickness`);A.onChange(e=>_({materialThickness:e})),l.push(A);let ee=t.add(e,`reset`).name(`reset`);return l.push(ee),i.current=l,()=>{t.destroy(),r.current=null,i.current=[],a.current=null,o.current=null,s.current=null}},[c,v,y,_]),(0,l.useEffect)(()=>{let e=r.current;e&&(rf(e,d,c),a.current?.enable(c!==`webgl`),o.current?.enable(d.useExplicitZMax),s.current?.show(d.mode===`compare`),i.current.forEach(e=>e.updateDisplay()))},[c,d]);let b=p.projectionWork+p.smoothingWork+p.meshWork+p.surfaceWork;return(0,$.jsxs)(`main`,{className:`app-shell`,children:[(0,$.jsx)(`div`,{ref:e,className:`stage`,"aria-label":`Liquid Lens demo viewport`}),(0,$.jsxs)(`header`,{className:`status-overlay`,children:[(0,$.jsx)(`strong`,{children:`Liquid Lens`}),(0,$.jsx)(`span`,{children:p.backend}),(0,$.jsxs)(`span`,{children:[p.fps,` fps`]}),(0,$.jsx)(`span`,{children:ff(d)}),d.freezeSurface&&(0,$.jsx)(`em`,{children:`frozen`})]}),(0,$.jsxs)(`aside`,{className:`perf-panel`,"aria-label":`Performance HUD`,children:[(0,$.jsxs)(`div`,{className:`perf-summary`,children:[(0,$.jsx)(`span`,{children:`hotspot`}),(0,$.jsx)(`strong`,{children:p.hotspot})]}),(0,$.jsxs)(`div`,{className:`perf-grid`,children:[(0,$.jsx)(of,{label:`CPU frame`,value:`${p.frameMs.toFixed(2)} ms`}),(0,$.jsx)(of,{label:`GPU sample`,value:cf(p.gpuTotalMs,p.gpuTimingMode)}),(0,$.jsx)(of,{label:`Draw calls`,value:p.drawCalls.toFixed(0)}),(0,$.jsx)(of,{label:`Dispatches`,value:p.computeDispatches.toFixed(0)}),(0,$.jsx)(of,{label:`Workgroups`,value:p.computeWorkgroups.toLocaleString()}),(0,$.jsx)(of,{label:`Depth memory`,value:`${p.depthMemoryMb.toFixed(2)} MB`})]}),(0,$.jsxs)(`div`,{className:`perf-bars`,children:[(0,$.jsx)(sf,{label:`CPU commands`,value:p.commandsMs,total:p.frameMs,detail:`${p.commandsMs.toFixed(2)} ms`}),(0,$.jsx)(sf,{label:`GPU compute`,value:p.gpuComputeMs??0,total:p.gpuTotalMs??0,detail:lf(p.gpuComputeMs,p.gpuTimingMode)}),(0,$.jsx)(sf,{label:`GPU render`,value:p.gpuRenderMs??0,total:p.gpuTotalMs??0,detail:lf(p.gpuRenderMs,p.gpuTimingMode)}),(0,$.jsx)(sf,{label:`Particle splat`,value:p.projectionWork,total:b,detail:`${df(p.projectionWork)} cells`}),(0,$.jsx)(sf,{label:`Depth smooth`,value:p.smoothingWork,total:b,detail:`${df(p.smoothingWork)} ops`}),(0,$.jsx)(sf,{label:`Mesh extract`,value:p.meshWork,total:b,detail:`${df(p.meshWork)} ops`}),(0,$.jsx)(sf,{label:`Surface draw`,value:p.surfaceWork,total:b,detail:`${df(p.surfaceWork)} vertices`})]}),(0,$.jsxs)(`div`,{className:`perf-foot`,children:[(0,$.jsx)(`span`,{children:p.canvas}),(0,$.jsxs)(`span`,{children:[p.gridCells.toLocaleString(),` cells`]}),(0,$.jsxs)(`span`,{children:[p.pixelRatio.toFixed(2),` dpr`]}),(0,$.jsx)(`span`,{children:uf(p.gpuTimingMode,p.gpuTimerAvailable)})]})]}),(0,$.jsxs)(`footer`,{className:`stats-bar`,children:[(0,$.jsx)(af,{label:`Particles`,value:p.particles.toLocaleString()}),(0,$.jsx)(af,{label:`Triangles`,value:p.triangles.toLocaleString()}),(0,$.jsx)(af,{label:`Vertices`,value:p.vertices.toLocaleString()}),(0,$.jsx)(af,{label:`Grid`,value:p.grid}),(0,$.jsx)(af,{label:`zmax`,value:ff(d)}),(0,$.jsx)(af,{label:`CPU frame`,value:`${p.frameMs.toFixed(1)} ms`})]}),d.mode===`compare`&&(0,$.jsxs)(`div`,{className:`split-marker`,style:{left:`${d.split*100}%`},children:[(0,$.jsx)(`span`,{children:`Particles`}),(0,$.jsx)(`span`,{children:`Surface`})]}),h&&(0,$.jsx)(`div`,{className:`error-banner`,children:h})]})}function nf(e,t,n){return{renderer:t,mode:e.mode,flow:e.preset,particles:e.particleCount,grid:e.gridSpacing,radius:e.particleRadius,thickness:e.materialThickness,depthBlur:e.depthSmoothing,silhouette:e.silhouetteSmoothing,explicitZMax:e.useExplicitZMax,zMax:e.zMax,split:e.split,freeze:e.freezeSurface,animate:e.animate,reset:n}}function rf(e,t,n){e.renderer=n,e.mode=t.mode,e.flow=t.preset,e.particles=t.particleCount,e.grid=t.gridSpacing,e.radius=t.particleRadius,e.thickness=t.materialThickness,e.depthBlur=t.depthSmoothing,e.silhouette=t.silhouetteSmoothing,e.explicitZMax=t.useExplicitZMax,e.zMax=t.zMax,e.split=t.split,e.freeze=t.freezeSurface,e.animate=t.animate}function af({label:e,value:t}){return(0,$.jsxs)(`div`,{className:`metric`,children:[(0,$.jsx)(`span`,{children:e}),(0,$.jsx)(`strong`,{children:t})]})}function of({label:e,value:t}){return(0,$.jsxs)(`div`,{className:`perf-metric`,children:[(0,$.jsx)(`span`,{children:e}),(0,$.jsx)(`strong`,{children:t})]})}function sf({label:e,value:t,total:n,detail:r}){let i=n>0?Math.max(3,Math.min(100,t/n*100)):0;return(0,$.jsxs)(`div`,{className:`perf-row`,children:[(0,$.jsx)(`span`,{children:e}),(0,$.jsx)(`div`,{className:`perf-track`,"aria-hidden":`true`,children:(0,$.jsx)(`i`,{style:{width:`${i}%`}})}),(0,$.jsx)(`strong`,{children:r})]})}function cf(e,t){return e===null?t===`unavailable`?`off`:`pending`:`${e.toFixed(2)} ms`}function lf(e,t){return e===null?t===`queue`?`needs timestamp`:`off`:`${e.toFixed(2)} ms`}function uf(e,t){return e===`timestamp`?`timestamp sample`:e===`queue`?t?`queue latency sample`:`queue fallback sample`:t?`GPU sample pending`:`GPU sample off`}function df(e){return Intl.NumberFormat(`en-US`,{notation:`compact`,maximumFractionDigits:1}).format(e)}function ff(e){let t=e.useExplicitZMax?e.zMax:pf(e),n=e.useExplicitZMax?`manual`:`auto`;return`${t.toFixed(2)} ${n}`}function pf(e){return Dd(e)}function mf(){let e=new URLSearchParams(window.location.search).get(`engine`);return e===`webgl-cpu`||e===`cpu`?`webgl-cpu`:e===`webgl`?`webgl`:`webgpu`}function hf(e){return e===`webgpu`?`starting WebGPU`:e===`webgl`?`starting WebGL texture`:`starting CPU reference`}(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(l.StrictMode,{children:(0,$.jsx)(tf,{})}));